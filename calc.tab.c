...
{
  "$end", "error", "$undefined", "ASSIGNMENT", "PLUS", "MINUS",
  "MULTIPLY", "DIVIDE", "NEWLINE", "LEFTPAREN", "RIGHTPAREN", "VARIABLE",
  "INTEGER", "$accept", "program", "statement", "expr", YY_NULLPTR
};
#endif
